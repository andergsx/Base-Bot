...
export async function callUpdate(callUpdate) {
    ...
    let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:Andxx - Bot\nFN:Andxxx 👑\nORG:Andxxx👑\nTITLE:\nitem1.TEL;waid=51912332440:+51912332440\nitem1.X-ABLabel:Andxxx 👑\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:Andxxx 👑\nEND:VCARD`
    await this.sendMessage(nk.from, { contacts: { displayName: 'Andxxx 👑', contacts: [{ vcard }] }}, {quoted: callmsg})
